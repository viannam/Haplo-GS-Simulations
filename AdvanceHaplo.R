...
####>>>>>-------------- Year 4
MaleYT2@ebv = as.matrix(runGBLUP(trainPop = trainPop, targetPop = MaleYT2, 
                                Model = "Haplo", nTraits = 1))                      #***
MaleYT3 = selectInd(MaleYT2, nInbred3, use = "ebv")

FemaleYT2@ebv = as.matrix(runGBLUP(trainPop = trainPopF, targetPop = FemaleYT2, 
                                 Model = "Haplo", nTraits = 1))                       #***
FemaleYT3 = selectInd(FemaleYT2, nInbred3, use = "ebv")
...
####>>>>>-------------- Year 3
MaleYT1@ebv = as.matrix(runGBLUP(trainPop = trainPop, targetPop = MaleYT1, 
                                   Model = "Haplo", nTraits = 1))                       #***
MaleYT2 = selectInd(selectWithinFam(MaleYT1, famMaxYT1, use = "ebv"), nInbred2, use = "ebv")

FemaleYT1@ebv = as.matrix(runGBLUP(trainPop = trainPopF, targetPop = FemaleYT1, 
                                 Model = "Haplo", nTraits = 1))                         #***
FemaleYT2 = selectInd(selectWithinFam(FemaleYT1, famMaxYT1, use = "ebv"), nInbred2, use = "ebv")
